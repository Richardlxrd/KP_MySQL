...
class editCustomersDataWidget extends StatefulWidget {
  const editCustomersDataWidget({super.key});

  @override
  State<editCustomersDataWidget> createState() =>
      _editCustomersDataWidgetState();
}

class _editCustomersDataWidgetState extends State<editCustomersDataWidget> {
  Future<void> updateDataCustomers(int ID, String C_FN, String C_MN,
